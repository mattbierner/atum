...
var bind = function(p, f) {
   ...
   //     var r = p(ctx);
    ...
    return stmt(function(ctx, k) {
        return p(ctx,
            function(x, ctx) {
                return new tail.Tail(f(x), ctx.setNow(new Date), k);
            });
    });
};
 ...
 */
var completeNormal = fun.composen(
    just,
 ...
 */
var completeThrow = fun.composen(
    just,
 ...
 */
var completeReturn = fun.composen(
    just,
 ...
 */
var completeBreak = fun.composen(
    just,
 ...
 * @param x Value to store in completion.
 */
var completeContinue = fun.composen(
    just,
...
var composeExpression = function(f, g) {
    return function(x) {
        return bindExpression(f(x), g);
    }
};
