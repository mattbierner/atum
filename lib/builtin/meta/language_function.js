 ...
 */
var LanguageFunction = record.declare(new meta_func.Function, [
    'proto',
    'properties',
    'scope',
    'id',
    ...
    'body',
    'strict'],
    function(proto, properties, scope, id, names, body, strict) {
        meta_func.Function.call(this, proto, properties);
        this.id = id;
        this.names = (names || []);
        this.scope = scope;
        this.body = body;
...
LanguageFunction.prototype.setPrototype = function(proto){
    return LanguageFunction.setProto(this, proto);
};
