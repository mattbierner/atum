...
Function.prototype.construct = function(self, args) {
    return value_reference.dereferenceFrom(
        ...
        function(proto, protoRef) {
            return compute.bind(
                object_operations.create(value.isObject(proto) ?
                    protoRef :
                ...
                function(ref) {
                    return value_reference.dereferenceFrom(
                        ...
                        function(result, resultRef) {
                            return compute.just(value.isObject(result) ? resultRef : ref);
                        });
                });
        });
};
        ...
        return compute.bind(
            ...
            function(v) {
                if (!value.isObject(v))
                    return compute.no;
                return compute.bind(
                    value_reference.getFrom(object_operations.get(ref, 'prototype')),
                    function(o) {
                        if (!value.isObject(o))
