...
var createCurrentEnvironment = function(func, names, args, strict) {
    return compute.bind(environment.getEnvironment, function(env) {
        return create(func, names, args, env, strict);
    });
};
...
exports.createCurrentEnvironment = createCurrentEnvironment;
