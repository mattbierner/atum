...
// @TOOD: replace with Math.abs once impl
var abs = function(x) {
    return (x >= 0 ? x : -x);
};
...
Object.defineProperty(Array.prototype, 'indexOf', {
    'value': function(searchElement, fromIndex) {
        ...
        if (len === 0)
            return -1;
        var n = (arguments.length > 1 ? +Number.prototype.toFixed.call(fromIndex) : 0);
        if (n >= len)
            return -1;
...
Object.defineProperty(Array.prototype, 'lastIndexOf', {
    'value': function(searchElement, fromIndex) {
        ...
        if (len === 0)
            return -1;
        var n = (arguments.length > 1 ? +Number.prototype.toFixed.call(fromIndex) : len - 1);
        if (n >= len)
            return -1;
