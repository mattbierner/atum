                ...
                compute.bind(
                    ...
                    function(descriptors) {
                        return descriptors.reduce(function(p, pair) {
                            return value_reference.dereferenceFrom(p, function(t, ref) {
...
var initialize = function() {
    return compute.sequence(
        ...
        builtin_function.create(object_refs.ObjectGetOwnPropertyNames, 'getOwnPropertyNames', 1, objectGetOwnPropertyNames),
