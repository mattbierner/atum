...
var initialize = function() {
    return compute.sequence(
        ...
        value_reference.setValue(compute.just(object_refs.ObjectCreate), builtin_function.create('create', 2, objectCreate)),
        value_reference.setValue(compute.just(object_refs.ObjectDefineProperty), builtin_function.create('defineProperty', 3, objectDefineProperty)),
        value_reference.setValue(compute.just(object_refs.ObjectDefineProperties), builtin_function.create('defineProperties', 3, objectDefineProperties)),
        value_reference.setValue(compute.just(object_refs.ObjectKeys), builtin_function.create('keys', 1, objectKeys)),
        
        object_refs.ObjectPrototype.setValue(new ObjectPrototype()),
        value_reference.setValue(compute.just(object_refs.ObjectPrototypeToString), builtin_function.create('toString', 0, objectPrototypeToString)),
        value_reference.setValue(compute.just(object_refs.ObjectPrototypeValueOf), builtin_function.create('valueOf', 0, objectPrototypeValueOf)));
};
