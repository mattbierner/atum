...
var ObjectConstruct = function(ref, args) {
    ...
    case type.UNDEFINED:
    case type.NULL:
        return construct.create(object_builtin.ObjectPrototype, {}, true);
...
var ObjectProperties = {
    ...
    'isExtensible': property.createValuePropertyFlags(
        object_builtin.ObjectIsExtensible,
        property.WRITABLE | property.CONFIGURABLE),
    ...
    'preventExtensions': property.createValuePropertyFlags(
        object_builtin.ObjectPreventExtensions,
        property.WRITABLE | property.CONFIGURABLE),
...
var objectCreate = function(ref, thisObj, args) {
    ...
    return value_reference.dereference(o, function(t) {
        ...
        var obj = compute.bind(
            construct.construct(object_builtin.Object, []),
            function(obj) {
...
var initialize = function() {
    return compute.sequence(
        builtin_constructor.create(object_builtin.Object, 'Object', 1, ObjectProperties, ObjectCall, ObjectConstruct),
        ...
        builtin_function.create(object_builtin.ObjectIsExtensible,'isExtensible', 1, objectIsExtensible),
        builtin_function.create(object_builtin.ObjectPreventExtensions,'preventExtensions', 1, objectPreventExtensions),
