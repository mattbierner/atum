...
var toPropertyDescriptor = (function(){
    ...
    var isCallable = function(v) {
        return compute.bind(v, function(ref){
            return compute.bind(value_reference_semantics.getValue(compute.just(ref)), function (obj) {
                return (value.isObject(obj) && value.isCallable(obj) ?
                    compute.just(ref) :
                    error.typeError());
            });
        });
    ...
    return compute.bind(
        ...
        function(t) {
            ...
            return compute.bind(
                ...
                function(obj) {
                    return (properties ?
                        objectDefineProperties(object_refs.ObjectDefineProperties, null, [args, properties]) :
                        compute.just(obj));
                });
        });
};
...
var objectKeys = function(ref, _, args) {
    return compute.bind(
        value_reference_semantics.getValue(compute.just(args.getArg(0))),
        function(obj) {
