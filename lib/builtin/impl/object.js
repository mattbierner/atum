...
var ObjectConstruct = function(ref, args) {
    ...
    case type.UNDEFINED:
    case type.NULL:
        return object_operations.create(object_builtin.ObjectPrototype, {});
...
var objectCreate = function(ref, thisObj, args) {
    ...
    return value_reference.dereference(o, function(t) {
        ...
        var obj = compute.bind(
            object_operations.construct(object_builtin.Object, []),
            function(obj) {
...
var objectKeys = function(ref, _, args) {
    return value_reference.dereference(args.getArg(0), function(obj, ref) {
        if (!obj || !value.isObject(obj))
            return error.typeError();
        return compute.bind(
            object_operations.getEnumerableProperties(ref),
            function(names) {
                return array.create(names.map(string.create));
            });
    });
};
...
var objectDefineProperties = (function(){
    var getDescriptors = function(obj) {
        return compute.bind(
            object_operations.getEnumerableProperties(obj),
            function(names) {
...
var objectGetOwnPropertyDescriptor = function(ref, _, args) {
    ...
    return value_reference.dereference(obj, function(t) {
        if (!value.isObject(t))
            return error.typeError();
        return object_operations.fromPropertyDescriptor(
            compute.bind(
                type_conversion.toString(prop),
                function(name) {
...
var objectPrototypeHasOwnProperty = function(ref, thisObj, args) {
    return boolean.from(
        compute.binary(
            ...
            function(o, v) {
                return object_operations.hasOwnProperty(o, v.value);
            }));
};
...
var initialize = function() {
    return compute.sequence(
        func.createConstructor('Object', 1, object_builtin.ObjectPrototype, object_builtin.Object.setValue(Object)),
        func_builtin.create(object_builtin.ObjectCreate, 'create', 2, objectCreate),
        func_builtin.create(object_builtin.ObjectDefineProperty, 'defineProperty', 3, objectDefineProperty),
        func_builtin.create(object_builtin.ObjectDefineProperties, 'defineProperties', 3, objectDefineProperties),
        func_builtin.create(object_builtin.ObjectGetOwnPropertyDescriptor, 'getOwnPropertyDescriptor', 2, objectGetOwnPropertyDescriptor),
        func_builtin.create(object_builtin.ObjectGetOwnPropertyNames, 'getOwnPropertyNames', 1, objectGetOwnPropertyNames),
        func_builtin.create(object_builtin.ObjectGetPrototypeOf, 'getGetPrototypeOf', 1, objectGetPrototypeOf),
        func_builtin.create(object_builtin.ObjectKeys,'keys', 1, objectKeys),
        
        object_builtin.ObjectPrototype.setValue(ObjectPrototype),
        func_builtin.create(object_builtin.ObjectPrototypeHasOwnProperty, 'hasOwnProperty', 0, objectPrototypeHasOwnProperty),
        func_builtin.create(object_builtin.ObjectPrototypeIsPrototypeOf, 'isPrototypeOf', 1, objectPrototypeIsPrototypeOf),
        func_builtin.create(object_builtin.ObjectPrototypePropertyIsEnumerable, 'propertyIsEnumerable', 1, objectPrototypePropertyIsEnumerable),
        func_builtin.create(object_builtin.ObjectPrototypeToString, 'toString', 0, objectPrototypeToString),
        func_builtin.create(object_builtin.ObjectPrototypeValueOf, 'valueOf', 0, objectPrototypeValueOf));
};
