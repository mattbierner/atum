...
var initialize = function() {
    return compute.sequence(
        func.createConstructor('Array', 1, array_builtin.ArrayPrototype, array_builtin.Array.setValue(Array)),
        
        func_builtin.create(array_builtin.ArrayIsArray, 'isArray', 1, arrayIsArray),
