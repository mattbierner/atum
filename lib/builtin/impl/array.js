...
var Array = new meta_builtin_constructor.BuiltinConstructor(
    func_builtin.FunctionPrototype, {
        'isArray': property.createValuePropertyFlags(array_ref.ArrayIsArray,
...
var ArrayPrototype = new meta_object.Object(builtin_object.ObjectPrototype, {
    'constructor': property.createValuePropertyFlags(array_ref.Array,
        property.WRITABLE | property.CONFIGURABLE)
});
...
var initialize = function() {
    return compute.sequence(
        ...
        func_builtin.create(array_ref.ArrayIsArray, 'isArray', 1, arrayIsArray),
