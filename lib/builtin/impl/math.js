...
var initialize = function() {
    ...
    return compute.sequence(
        ...
        func_builtin.create(math_ref.MathAcos, 'acos', 1, mathAcos),
        func_builtin.create(math_ref.MathAsin, 'asin', 1, mathAsin),
        func_builtin.create(math_ref.MathAtan, 'atan', 1, mathAtan),
        func_builtin.create(math_ref.MathAtan2, 'atan2', 2, mathAtan2),
        func_builtin.create(math_ref.MathCeil, 'ceil', 1, mathCeil),
        func_builtin.create(math_ref.MathCos, 'cos', 1, mathCos),
        func_builtin.create(math_ref.MathExp, 'exp', 1, mathExp),
        func_builtin.create(math_ref.MathFloor, 'floor', 1, mathFloor),
        func_builtin.create(math_ref.MathLog, 'log', 1, mathLog),
        func_builtin.create(math_ref.MathPow, 'power', 2, mathPow),
        func_builtin.create(math_ref.MathRandom, 'random', 0, mathRandom),
        func_builtin.create(math_ref.MathRound, 'round', 1, mathRound),
        func_builtin.create(math_ref.MathSin, 'sin', 1, mathSin),
        func_builtin.create(math_ref.MathSqrt, 'sqrt', 1, mathSqrt),
        func_builtin.create(math_ref.MathTan, 'tan', 1, mathTan));
};

var configure = function(mutableBinding, immutableBinding) {
    return mutableBinding('Math', math_ref.Math);
};
