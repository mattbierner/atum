 ...
 * `EvalError.prototype`
 */
var EvalErrorPrototype = defineNativeErrorPrototype(native_error_refs.EvalError, 'EvalError');
 ...
 * `EvalError.prototype`
 */
var RangeErrorPrototype = defineNativeErrorPrototype(native_error_refs.RangeError, 'RangeError');
 ...
 * `EvalError.prototype`
 */
var ReferenceErrorPrototype = defineNativeErrorPrototype(native_error_refs.ReferenceError, 'ReferenceError');
 ...
 */
var SyntaxErrorPrototype = defineNativeErrorPrototype(native_error_refs.SyntaxError, 'SyntaxError');
 ...
 * `TypeError.prototype`
 */
var TypeErrorPrototype = defineNativeErrorPrototype(native_error_refs.TypeError, 'TypeError');
 ...
 * `UriError.prototype`
 */
var UriErrorPrototype = defineNativeErrorPrototype(native_error_refs.UriError, 'UriError');
