...
var initialize = function() {
    ...
    return compute.sequence(
        ...
        func_builtin.create(regexp_ref.RegExpPrototypeExec, 'exec', 1, regexpPrototypeExec),
        func_builtin.create(regexp_ref.RegExpPrototypeToString, 'toString', 0, regexpPrototypeToString));
};
