...
var initialize = function() {
    return compute.sequence(
        func.createConstructor('String', 1, string_builtin.StringPrototype, string_builtin.String.setValue(String)),

        string_builtin.StringPrototype.setValue(StringPrototype),
        func_builtin.create(string_builtin.StringPrototypeCharCodeAt, 'charCodeAt', 1, stringPrototypeCharCodeAt),
        func_builtin.create(string_builtin.StringPrototypeMatch, 'match', 1, stringPrototypeMatch),
        func_builtin.create(string_builtin.StringPrototypeReplace, 'replace', 2, stringPrototypeReplace),
        func_builtin.create(string_builtin.StringPrototypeSplit, 'split', 2, stringPrototypeSplit),
        func_builtin.create(string_builtin.StringPrototypeToString, 'toString', 0, stringPrototypeToString),
        func_builtin.create(string_builtin.StringPrototypeValueOf, 'valueOf', 0, stringPrototypeValueOf));
};
