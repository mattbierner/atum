...
Function.prototype = new meta_builtin_constructor.BuiltinConstructor;
Function.prototype.constructor = Function;

Function.prototype.proto = func_ref.FunctionPrototype;
...
/**
 */
Function.prototype.call = function(ref, thisArg, args) {
 ...
 */
Function.prototype.construct = function(ref, args) {
    if (args.length === 0)
    ...
    return compute.binds(
        ...
        function(/**/) {
            var fn = "(function(" + [].slice.call(arguments, 0, -1).map(function(x){ return x.value; }).join(',') + ") {" + arguments[arguments.length - 1].value +"})";
            return evaluation.evaluate(fn);
        });
};
    ...
    return compute.bind(
        ...
        function(t) {
            ...
            return compute.bind(value_reference.getValue(compute.just(argArray)), function(argArray) {
                ...
                return compute.bind(object.get(argArray, 'length'), function(len) {
                    return (function loop(i, args) {
                        return (i >= len.value ?
                            t.call(ref, thisArg, args) :
                            compute.bind(object.get(argArray, i + ''), function(nextArg) {
