...
var functionPrototypeCall = function(ref, thisObj, args) {
    return value_reference.dereference(thisObj, function(t) {
        ...
        return func.apply(thisObj, args.getArg(0), args.slice(1));
    });
};
...
var initialize = function() {
    ...
    return compute.sequence(
        ...
        func_builtin.create(func_ref.FunctionPrototypeApply, 'apply', 2, functionPrototypeApply),
        func_builtin.create(func_ref.FunctionPrototypeBind, 'bind', 1, functionPrototypeBind),
        func_builtin.create(func_ref.FunctionPrototypeCall, 'call', 1, functionPrototypeCall));
};
