...
var functionPrototypeApply = function(ref, thisObj, args) {
    return compute.bind(
        ...
        function(t) {
            ...
            return compute.bind(
                value_reference.getValue(compute.just(argArray)),
                function(argArray) {
...
var initialize = function() {
    ...
    return compute.sequence(
        func.createConstructor('Function', 1, func_ref.FunctionPrototype, func_ref.Function.setValue(new Function())),
