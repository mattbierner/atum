...
Number.prototype.construct = function(args) {
    return compute.bind(this.call(null, null, args), function(num) {
        return value_reference.create(new NumberPrototype(num));
    });
};
...
var initialize = function() {
    ...
    return compute.sequence(
        ...
        value_reference.setValue(compute.just(number_ref.NumberPrototypeToString), builtin_function.create('toString', 0, numberPrototypeToString)),
        value_reference.setValue(compute.just(number_ref.NumberPrototypeValueOf), builtin_function.create('valueOf', 0, numberPrototypeValueOf)));
};
