...
var createGlobalBindings = function() {
    var immutableBinding = function(name, value) {
        return environment_semantics.putStrictnessImmutableBinding(name, false, value);
    };
    var mutableBinding = function(name, value) {
        return environment_semantics.putStrictnessMutableBinding(name, false, value);
    };
...
var createGlobal = compute.bind(
    environment_semantics.createObjectEnvironment(null, global_builtin.global),
    function(lex) {
