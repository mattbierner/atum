...
/* BooleanPrototype
 ******************************************************************************/
var BooleanPrototype = new meta_object.Object(builtin_object.ObjectPrototype, {
    'constructor': {
...
var initialize = function() {
    ...
    return compute.sequence(
        func.createConstructor('Boolean', 1, boolean_ref.BooleanPrototype, boolean_ref.Boolean.setValue(Boolean)),

        boolean_ref.BooleanPrototype.setValue(BooleanPrototype),
        func_builtin.create(boolean_ref.BooleanPrototypeToString, 'toString', 0, booleanPrototypeToString),
        func_builtin.create(boolean_ref.BooleanPrototypeValueOf, 'valueOf', 0, booleanPrototypeValueOf));
};

var configure = function(mutableBinding, immutableBinding) {
    return mutableBinding('Boolean', boolean_ref.Boolean);
};
