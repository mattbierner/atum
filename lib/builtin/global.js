...
var initialize = function() {
    return compute.sequence(
        ...
        func.initialize(),
        number.initialize(),
        environment_semantics.setMutableBinding('undefined', false, compute.always(undef.UNDEFINED)),
        environment_semantics.setMutableBinding('Number', false, compute.always(number.numberRef)),
