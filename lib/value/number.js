...
var toExponential = function(x, fractionDigits) {
    return new NumberValue(Number.prototype.toExponential.call(x.value, fractionDigits));
};
...
var toFixed = function(x, fractionDigits) {
    ...
    return new NumberValue(Number.prototype.toFixed.call(x.value, fractionDigits));
};
...
var toPrecision = function(x, precision) {
    return new NumberValue(Number.prototype.toPrecision.call(x.value, precision));
};
