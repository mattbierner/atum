...
Binding.prototype.toString = function() {
    return (this.mutable ?
        "{MutableBinding " + this.value + "}" :
        "{ImmutableBinding " + this.value + "}");
};

/* Environment Record
 ******************************************************************************/
/**
 * Environment record that holds a set of bindings.
 * 
 ...
 * environment record.
 * 
 * Environment record do not enforce anything.
 */
var EnvironmentRecord = function() { };

/**
 * Does the given environment record have a binding for 'n'.
 * 
 ...
 * @param v Binding value.
 */
var putImmutableBinding = function(env, name, v) { 
    return amulet_object.defineProperty(record, name, {
