 ...
 ******************************************************************************/
var DeclarativeEnvironmentRecord = function(o) {
    return Object.defineProperty(o, 'implicitThisValue', {
        'enumerable': true,
        'value': function() {
            return undefined;
        }
 ...
 ******************************************************************************/
var ObjectEnvironmentRecord = function(o) {
    return Object.defineProperty(o, 'implicitThisValue', {
        'enumerable': true,
        'value': function() {
            return undefined;
...
var newDeclarativeEnvironment = function(outer) {
    return new LexicalEnvironment(outer, DeclarativeEnvironmentRecord({}));
};
 ...
 * @param [outer] Parent of new environment.
 */
var newObjectEnvironment = function(outer, o) {
    return new LexicalEnvironment(outer, ObjectEnvironmentRecord(o));
};
