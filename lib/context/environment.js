 ...
 * 
 */
LexicalEnvironment.prototype.setMutableBinding = function(ref, name, value) {
    return ref.setValue(new LexicalEnvironment(
        this.outer,
        environment_record.setMutableBinding(this.record, name, value)));
};

LexicalEnvironment.prototype.putImmutableBinding = function(ref, name, value) {
    return ref.setValue(new LexicalEnvironment(
        this.outer,
...
DeclarativeLexicalEnvironment.prototype.setMutableBinding = function(ref, name, value) {
    return ref.setValue(new DeclarativeLexicalEnvironment(
        this.outer,
        environment_record.setMutableBinding(this.record, name, value)));
};
...
ObjectLexicalEnvironment.prototype.setMutableBinding = function(ref, name, value) {
    return object.set(compute.just(this.record), name, compute.just(value));
};
