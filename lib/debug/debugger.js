...
Debugger.create = function(p, ctx, ok, err) {
    var pok = function(x, ctx) {
        var c = ok(x, ctx);
        return function() { return new Debugger(null, c(), ctx, true); };
    },
    perr = function(x, ctx) {
        var c = err(x, ctx);
        return function() { return new Debugger(null, c(), ctx, true); };
    };
    return new Debugger(null, function() { return function(){ return p(ctx, pok, perr); }; }, ctx, false);
};
...
Debugger.prototype.run = function(p, ok, err) {
    return compute.trampoline(p(this.ctx, ok, err));
};
...
Debugger.prototype.step = function() {
    var next = compute.trampoline(this.k()());
