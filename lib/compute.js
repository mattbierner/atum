...
/* 
 ******************************************************************************/
var from = fun.curry(fun.compose, just);
...
var lift2 = function(f) {
    return function(m1, m2) {
        return bind(m1, function(x) {
            return bind(m2, function(y) {
                return just(f(x, y));
            });
        });
    };
...
var composes = function(/*...*/) {
    return Array.prototype.reduce.call(arguments, compose);
};
