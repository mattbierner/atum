 ...
 */
var emptyStatement = compute.createBlock(statement.emptyStatement);
...
var withStatement = fun.compose(
    compute.createBlock,
    function(expr, body) {
        return statement.withStatement(
            expr,
...
var forVarInStatement = fun.compose(
    compute.createBlock, 
    function(lhs, rhs, body) {
        return statement.forVarInStatement(
            lhs,
            rhs,
            compute.dispatch(body));
    });
 ...
 ******************************************************************************/
return {
    'statementNext': statement.statementNext,
