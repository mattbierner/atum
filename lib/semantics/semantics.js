...
var switchStatement = function(discriminant, preCases, defaultCase, postCases) {
    ...
    return compute.bind(
        ...
        function(x) {
            ...
            return preCases.reduceRight(function(p, c, i) {
...
var memberExpression = function(base, property) {
    return compute.Computation('Member Expression',
        compute.binda(
            ...
            function(ctx, baseRef, baseValue, name) {
                return compute.always(baseValue instanceof environment.LexicalEnvironment ?
                    new environment_semantics.EnvironmentReference(name.value, baseRef, ctx.strict) :
                    new object.PropertyReference(name.value, baseRef, ctx.strict));
            }));
};
