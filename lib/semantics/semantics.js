...
define(['atum/compute',
        ...
        'atum/operations/number', 'atum/semantics/string', 'atum/operations/boolean', 'atum/semantics/object',
...
var expressionStatement = function(expr) {
    return attempt(completion_semantics.createNormalCompletion(reference_semantics.tryGetValue(expr)));
};
...
var returnStatement = function(argument) {
    return compute.Computation('Return Statement',
        attempt(completion_semantics.createReturnCompletion(reference_semantics.tryGetValue(argument))));
};
