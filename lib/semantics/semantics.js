    ...
    // Clauses
        case 'SwitchCase':
            return {
                ...
                'consequent': mapSemantics(node.consequent)
            };
    ...
    // Declarations
        case 'VariableDeclaration':
            return statementLoc(loc, declarationStatement(
                mapSemantics(node.declarations)));
...
var objectExpression = (function(){
    var getProperty = function(key, property) {
    ...
    var getProperties = function(properties) {
        return fun.foldl(function(p, c) {
            ...
            return p.concat(getProperty(key, c));
        }, [], properties);
    };
