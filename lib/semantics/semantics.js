...
var sourceElements = function(elems) {
    return compute.bind(compute.enumerationa(fun.map(mapSemantics, elems)), function(vals) {
...
var mapSemantics = (function(){
    ...
    // Declarations
        case 'VariableDeclaration':
            return compute.just(variableDeclaration(node.declarations));
...
var expressionStatement = function(expr) {
    return statement_semantics.expressionStatement(mapSemantics(expr));
};
...
var returnStatement = function(argument) {
    return statement_semantics.returnStatement(argument ?
...
var withStatement = function(object, body) {
    return compute.bind(mapSemantics(body), function(body) {
        ...
        return compute.bind(
            ...
            function(consequent) {
                return compute.just({
                    ...
                    'consequent': statement_semantics.statementList(consequent)
                });
            });
    };
    ...
    var d = function(x) {
        return compute.bind(
            (def ?
                ...
                compute.enumeration(statement_semantics.emptyStatement)),
            function(consequent){
                return compute.just({
                    'consequent': statement_semantics.statementList(consequent)
                });
...
var doWhileStatement = function(body, test) {
    return compute.bind(mapSemantics(body), function(body) {
        statement_semantics.doWhileStatement(
            body,
            mapSemantics(test));
    });
};
...
var functionExpression = function(id, params, body) {
    ...
    return compute.bind(sourceElements(body.body), function(body) {
