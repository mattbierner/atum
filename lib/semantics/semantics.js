            ...
            compute.bind(
                ...
                function(x) {
                    if (x instanceof completion.Completion) {
                        switch (x.type) {
                        case 'continue':    return completion_semantics.createContinueCompletion(x.target, val);
                        case 'break':       return completion_semantics.createBreakCompletion(x.target, val);
