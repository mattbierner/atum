...
var statementNext = function(p, q) {
    return compute.bind(p, function(x) {
        ...
        return compute.bind(
            compute.bindError(q, function(e) {
                return compute.never(new completion.ThrowCompletion(e.value, x));
            }),
            function(y) {
...
var throwStatement = function(argument) {
    return compute.Computation('Throw Statement',
        compute.bind(
            ...
            function(e) {
                return compute.never(new completion.ThrowCompletion(e));
            }))
};
                        ...
                        function(e) {
                            return environment_semantics.withEnvironment(e,
                                compute.next(
                                    ...
                                    compute.bindError(statementNext((error.previous ? compute.always(error.previous) : emptyStatement()), handler), function(e) {
                                        return compute.next(finalizer, compute.never(e));
                                    })));
                        });
                    });
                }),
...
var variableInitDeclarator = function(id, init) {
    return compute.bind(
        compute.getContext(),
        function(ctx) {
            return environment_semantics.putMutableBinding(id, ctx.strict, internal_reference.getValue(init));
        });
};
