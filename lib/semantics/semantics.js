                ...
                return compute.binda(
                    ...
                    function(args, base) {
                        ...
                        if (ref instanceof reference.Reference) {
                            return func.call(ref.isProperty ? base : base.implicitThisValue(), args);
                        }
                        return func.call(undef.create(), args);
                    });
            }));
};
    ...
    return compute.Computation('Member Expression',
        compute.binda(
            ...
            function(ctx, baseValue, name) {
                return compute.always(new object.ValueReference(name.value, baseValue, ctx.strict));
            }));
};
