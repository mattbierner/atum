...
var variableInitDeclarator = function(id, init) {
    return environment.putMutableBinding(id, debug.debuggable(internal_reference.getValue(init)));
};
...
var functionDeclaration = function(name, params, body) {
    return environment.putMutableBinding(name, func_semantics.functionExpression(name, params, body));
};
