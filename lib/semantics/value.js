        ...
        return compute.bind(
            ...
            function(value) {
                return compute.bind(p, function(ref) {
                    return compute.next(
                        object.defineProperty(compute.just(ref), key, property.createValueProperty(
                        value,
                        prop.enumerable,
                        prop.writable,
                        prop.configurable)), compute.just(ref));
                });
            });
    }, construct.construct(object_builtin.Object, []), Object.keys(properties));
};
