 ...
 */
var typeofOperator = compute.composes(
...
var _prefixUpdate = function(op) {
    return function(arg) {
        return compute.bind(arg, function(x) {
            ...
            return internal_reference.dereference(x, compute.compose(
                type_conversion.toNumber,
                function(val) {
                    return op(x, val);
                }));
...
var callExpression = (function() {
    ...
    return function(callee, args) {
        var a = compute.enumerationa(fun.map(internal_reference.getFrom, args));
