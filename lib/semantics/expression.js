            ...
            function(ref, calleeRef, func) {
                return compute.binds(
                    ...
                    function(args, base) {
                        ...
                        return func.call(calleeRef,
                            (ref instanceof internal_reference_value.InternalReference ?
...
var _dereference = function(lref) {
    if (lref instanceof internal_reference_value.InternalReference &&
        lref.strict &&
...
var assignment = function(left, right) {
    return compute.bind(compute.bind(left, _dereference), function(l) {
        return compute.bind(internal_reference.getValue(right), function(r) {
            return compute.next(l.setValue(r), compute.always(r));
        });
    });
};
