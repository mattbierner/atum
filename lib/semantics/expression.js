            ...
            compute.binary(
                ...
                function(lref, rref) {
                    return compute.bind(value_reference.getValue(compute.just(rref)), function(rval) {
                        ...
                        return compute.bind(type_conversion.toString(compute.just(lref)), function(key) {
    ...
    var getThisBinding = function(ref) {
        return (ref instanceof internal_reference_value.InternalReference ?
            compute.bind(ref.getBase(), function(base) {
                return compute.just(ref instanceof property_reference.PropertyReference ?
                    base :
