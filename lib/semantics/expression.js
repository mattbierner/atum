...
var callExpression = (function() {
    ...
    return function(callee, args) {
        var a = compute.eager(compute.mapm(internal_reference.getFrom, args));
...
var newExpression = function(callee, args) {
    return compute.binds(
        compute.enumeration(
            ...
            compute.eager(compute.mapm(internal_reference.getFrom, args))),
        construct.construct);
};
    ...
    return internal_reference.dereferenceFrom(base, function(baseValue, baseRef) {
        return compute.bind(
            ...
            function(propertyName) {
                return (baseValue instanceof environment_record.LexicalEnvironment ?
 ...
 */
var sequenceExpression = fun.curry(compute.mapm_,
    internal_reference.getFrom);
