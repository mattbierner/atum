...
var callExpression = (function() {
    ...
    return function(callee, args) {
        var a = compute.eager(compute.enumerationa(fun.map(internal_reference.getFrom, args)));
...
var newExpression = function(callee, args) {
    return compute.binds(
        compute.enumeration(
            ...
            compute.eager(compute.enumerationa(fun.map(internal_reference.getFrom, args)))),
        construct.construct);
};
