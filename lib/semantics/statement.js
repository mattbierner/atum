 ...
 */
var emptyStatement = debug_operations.debuggableStatement(statement.empty);
...
var expressionStatement = fun.compose(
    debug_operations.debuggableStatement,
    fun.compose(
 ...
 */
var blockStatement = fun.curry(fun.reduce, statementNext, emptyStatement);
...
var switchStatement = fun.compose(
    debug_operations.debuggableStatement,
    function(discriminant, preCases, defaultCase, postCases) {
