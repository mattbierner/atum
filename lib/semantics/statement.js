 ...
 */
var statementList = fun.curry(fun.foldl, statementNext, statement.empty);
...
var switchStatement = function(discriminant, preCases, defaultCase, postCases) {
    ...
    var consequents = fun.foldr(function(p, c) {
