            ...
            return environment.environmentBlock(
                compute.next(
                    compute.bind(environment.getEnvironment, function(env) {
                        return compute.bind(environment.createObjectEnvironment(env, obj), environment.setEnvironment);
                    }),
                    body));
        });
};
...
var forInStatement = function(lhs, rhs, body) {
    return compute.bind(attempt(internal_reference.getFrom(rhs)), function(x) {
...
var tryCatchFinallyStatement = (function(){
    ...
    return function(body, handlerId, handler, finalizer) {
        var catchBody = function(value, previous) {
            return environment.environmentBlock(compute.next(
                compute.bind(compute.bind(environment.getEnvironment, environment.createDeclativeEnvironment), environment.setEnvironment),
                compute.next(
