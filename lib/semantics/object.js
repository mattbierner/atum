...
PropertyReference.prototype.getValue = function() {
    return (this.isUnresolvable ?
        ...
        get(internal_reference_semantics.getValue(compute.always(this.base)), this.name));
};

PropertyReference.prototype.setValue = function(value) {
    return compute.next(
        defineProperty(
            reference_semantics.getValue(compute.always(this.base)),
            this.name, {
                'value': value,
                'enumerable': true,
                'configurable': true
        ...
        function(ref, o) {
            return compute.binds(
                ...
                function(value, get, set) {
                    ...
                    return compute.next(
                        ref.setValue(compute.always(obj)),
                        compute.always(ref));
                });
        });
};
