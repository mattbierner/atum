...
var debug = function(p, ctx, ok, err) {
    return p(ctx, ok, err);
};
...
var eval = function(comp) {
    return exec(comp, new compute.ComputeContext({}, null), ret, thr);
};
...
var interpret = (function(){
    ...
    return function(root) {
        return eval(extract(compute.next(global.initialize(), evaluate(root))));
    };
}());
