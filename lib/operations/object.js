 ...
 * 
 */
var setPrototype = function(obj, proto) {
    return value_reference.modifyValue(compute.just(obj), function(obj) {
...
var hasProperty = function(obj, name) {
    return value_reference.dereferenceFrom(obj, function(o, ref) {
...
var typeofObject = function(obj) {
    return compute.bind(
        ...
        function(val) {
            ...
            case type.BOOLEAN_TYPE:     return compute.just("boolean");
            case type.NULL_TYPE:        return compute.just("object");
            case type.NUMBER_TYPE:      return compute.just("number");
            case type.OBJECT_TYPE:      return compute.just(value.isCallable(val) ? "function" : "object");
            case type.STRING_TYPE:      return compute.just("string");
            case type.UNDEFINED_TYPE:   return compute.just("undefined");
...
var defineProperty = function(ref, name, desc) {
    ...
    return value_reference.dereferenceFrom(ref, function(obj, objRef) {
        if (property.isAccessorDescriptor(desc)) {
            ...
            return compute.bind(desc.value, function(value) {
...
var deleteProperty = function(ref, name) {
    return value_reference.dereferenceFrom(ref, function(obj, ref) {
