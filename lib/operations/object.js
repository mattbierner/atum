...
var hasProperty = function(ref, name) {
    return compute.bind(
        error.assert(
            value.isObject,
            error.typeError(string.create('hasProperty on non-object')),
            value_reference.getValue(ref)),
        function(val) {
...
var getOwnProperty = function(ref, name) {
    return value_reference.dereference(ref, function(val, ref) {
        if (!value.isObject(val) || !val.hasOwnProperty)
            return error.typeError(string.create('getOwnProperty on non-object'));
...
var getOwnPropertyNames = function(ref) {
    return value_reference.dereference(ref, function(val, ref) {
        if (!value.isObject(val))
            return error.typeError(string.create('getOwnPropertyNames on non-object'));
...
var defineProperty = function(ref, name, desc) {
    name = name + '';
    return value_reference.dereference(ref, function(obj, objRef) {
        return compute.next(
            obj.defineProperty(objRef, name,
                (property.isAccessorDescriptor(desc) ?
                     property.createAccessorProperty(
                        desc.get,
                        desc.set,
                        desc.enumerable,
                        desc.configurable) :
...
var typeofObject = function(obj) {
    return value_reference.dereference(obj, function(val) {
        ...
        return error.typeError(string.create('cannot get typeof value'));
    });
};
