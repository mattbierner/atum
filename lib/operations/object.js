...
var construct = function(callee, a) {
    return compute.binds(
        compute.enumeration(
            value_reference.getFrom(compute.just(callee))),
        function(obj) {
...
var hasProperty = function(obj, name) {
    return compute.bind(obj, function(ref) {
        return compute.bind(
            value_reference.getFrom(compute.just(ref)),
            function(o) {
...
var defineProperty = function(ref, name, desc) {
    name = name + '';
    return value_reference.dereference(ref, function(objRef, obj) {
...
var deleteProperty = function(ref, name) {
    return compute.bind(ref, function(ref) {
        return compute.bind(value_reference.getFrom(compute.just(ref)), function(obj) {
