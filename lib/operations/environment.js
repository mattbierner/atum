...
var createDeclativeEnvironment = function(outer) {
    return compute.bind(outer || compute.empty, function(outer) {
...
var createObjectEnvironment = function(outer, obj) {
    return iref.create(compute.just(new environment.ObjectLexicalEnvironment(outer, obj, true)));
};
...
var putMutableIdentifierReference = function(env, name, value) {
    return internal_reference.modifyValue(env, function(lex) {
        return lex.setMutableBinding(name, value);
    });
};
...
var putImmutableIdentifierReference = function(env, name, value) {
    return internal_reference.modifyValue(env, function(lex) {
        return lex.putImmutableBinding(name, value);
    });
};
