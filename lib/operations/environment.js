...
var createCurrentObjectEnvironment = function(obj) {
    return compute.bind(getEnvironment, function(env) {
        return createObjectEnvironment(env, obj);
    });
};
...
var putEnvironmentMutableBinding = function(environment, name, strict, value) {
    return compute.next(
        putMutableIdentifierReference(environment, name, value, strict),
        compute.just(value));
};
...
var putEnvironmentImmutableBinding = function(environment, name, strict, value) {
    return compute.next(
        putImmutableIdentifierReference(environment, name, value, strict),
        compute.just(value));
};
 ...
 * @param value Value being bound.
 */
var putStrictnessImmutableBinding = fun.curry(putEnvironmentMutableBinding, getEnvironment);
