 ...
 ******************************************************************************/
/**
 * Computation of if the result of computation `callee` a callable hosted object.
 */
var isCallable = function(callee) {
    return compute.bind(value_reference.getValue(callee), function(obj) {
            ...
            function(func, t, args) {
                if (!value.isCallable(func))
                    return error.typeError(
                        string.concat(
                            string.create("'"),
                            type_conversion.toString(calleeRef),
