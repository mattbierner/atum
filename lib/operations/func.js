...
var forward = function(callee, thisBinding, args) {
    return value_reference.dereference(callee, function(func) {
        if (!value.isCallable(func))
            return error.typeError("'", callee, "' is not a function");
...
var apply = function(callee, thisBinding, a) {
    return forward(callee, thisBinding, args_value.Args.create(a));
};
 ...
 * 
 */
var functionApply = function(callee, thisBinding, a) {
    return functionForward(callee, thisBinding, args_value.Args.create(a));
};
