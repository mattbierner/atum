 ...
 */
define(['atum/context/execution_context',
        'atum/operations/execution_context'],
function(context_execution_context,
        execution_context) {
"use strict";
 ...
 */
var settings = extract(function(settings) { return settings; });
...
var setSettings = function(settings) {
    return modifySettings(function(){ return settings; });
};
