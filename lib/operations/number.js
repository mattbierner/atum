 ...
 */
var create = compute.from(number.Number.create);

/**
 * Create a new hosted number value from the results of a computation.
 */
var from = compute.lift(number.Number.create);
...
/* Numeric Conversion
 ******************************************************************************/
var toExponential = compute.from(number.toExponential);

var toFixed = compute.from(number.toFixed);

var toPrecision = compute.from(number.toPrecision);
