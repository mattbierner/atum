...
implementation of functional interpreters. It is part of Pyramid,
a project developing a complete functional style Javascript implementation.
...
* Enable rapid prototyping and experimentation of Javascript language.
* Support substantial hosted language alterations with minimal changes.
...
issue tracker to see some features that are being worked on or are not yet
supported.
...
Composed computations and minial reliance on the host language allow Atum to
altered core language features easily and introduce new language features. For
